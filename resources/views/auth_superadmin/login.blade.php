                    ...
                    <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                        <div class="card border-grey border-lighten-3 m-0">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form-horizontal form-simple" method="POST" action="{{ route('admin.login.submit') }}">
                                        @csrf
                            ...
                            <div class="card-footer">
                                <div class="">
                                    <p class="float-sm-right text-center m-0"><a href="{{route('admin.register')}}" class="card-link">Register</a>
                                    </p>
                                </div>
                            </div>
                        </div>
