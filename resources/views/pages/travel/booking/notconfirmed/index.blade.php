                                ...
                                <table class="table table-striped table-bordered base-style">
                                    ...
                                    @foreach($datas as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('booking-notconfirmed.show', $data->id)}}" class="btn btn-info btn-sm"><i
                                                            class="fa fa-eye"></i></a>
                                                <a href="{{route('booking-notconfirmed.update', $data->id)}}" class="btn btn-warning btn-sm"><i
                                                            class="fa fa-check"></i></a>
                                                <a href="{{route('booking-notconfirmed.destroy', $data->id)}}" class="btn btn-danger btn-sm">
