<head>
    ...
    <title>TravelMe -  Admin Travel</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/app-assets/vendors/css/animate/animate.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/app-assets/css/plugins/forms/extended/form-extended.min.css')}}">
